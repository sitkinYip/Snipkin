...
- compress_audio_handler:  音频压缩的事件处理
"""
...
from snipkin.handlers.compress_audio_handler import (
    handle_compress_run,
    on_input_file_picked as on_compress_audio_input_picked,
    on_output_file_picked as on_compress_audio_output_picked,
)
...
__all__ = [
    ...
    "handle_compress_run",
    "on_compress_audio_input_picked",
    "on_compress_audio_output_picked",
]
